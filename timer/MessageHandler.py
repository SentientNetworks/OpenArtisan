...
def api_process(payload):
    ...
    try:
        ...
        response = requests.post(MESSAGE_SERVER_URL, json=payload)
        afterTime = time.time()
...
def handle(messages, handler_name="client"):
    ...
    try:
        ...
        print("MessageHandler::process_messages: at beginning")
        ...
        print(f"MessageHandler::process_messages: payload is {in_payload}")
        ...
        print(f"MessageHandler::process_messages: response string is {response_message_str}")
        ...
        if response_message_str is not None:
            ...
            for response in responses:
                ...
                print(f"MessageHandler::process_messages: augmented_response is {augmented_response}")
        ...
        print(f"MessageHandler::process_messages: error: {e}")

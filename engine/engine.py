...
def process_messages():
    ...
    print()
    print("---------------------")
    print(f"engine::process_messages: before time is {beforeDatetime}")
    print(f"engine::process_messages: after time is {afterDatetime}")
    print(f"engine::process_messages: elapsed time in seconds is {elapsedTime}")
    print("---------------------")
    print()

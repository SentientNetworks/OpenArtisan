import MemoryHandler, ClientHandler, FunctionHandler, EngineHandler, TimerHandler
...
QUEUE_HANDLER_NAMES = [CLIENT_HANDLER, MEMORY_HANDLER, ENGINE_HANDLER, FUNCTION_HANDLER, TIMER_HANDLER]

CLIENT_HANDLER_INDEX = 0 
MEMORY_HANDLER_INDEX = 1
ENGINE_HANDLER_INDEX = 2
FUNCTION_HANDLER_INDEX = 3
TIMER_HANDLER_INDEX = 4

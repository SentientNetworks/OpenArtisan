'''
This module contains the client method handle used ot handle connections for a given client.
'''
...
class CTimerHandler:
    ...
    def handle(cls, out_handler, in_handler, messages = None):
            ...
            _print(f"4. CTimerHandler::handle: type is inout and messages is {messages}")
            ...
            # Unsure if this should be done with timer messages
            ...
            _print(f"CTimerHandler::handle: keep_response = {keep_response}, client tag = {client_tag}, response_str = {response_str}")
            ...
            _print("11. CTimerHandler::handle: Processed response:", response_str)    

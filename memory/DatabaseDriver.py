...
class CDatabaseDriver:
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if cls.client is None:
            return None
        return super(CDatabaseDriver, cls).__new__(cls)
    ...
    def insert_row(self, table, fields):
        ...
        try:
            ...
            print(f"CDatabaseDriver::insert_row: Error connecting to MongoDB: {e}")
            return None
    ...
    def read_row(self, table, row_id=None, fields=None):
        ...
        try:
            ...
            print(f"CDatabaseDriver::read_row: Error connecting to MongoDB: {e}")
            return None

    def find_row(self, table, query, projection):
        '''
        Does a more general find of all documents in a collection
        '''

        try:
            if table is None:  
                print(f"CDatabaseDriver::find_row: table is None")              
                return None

            if len(query) == 0:
                print(f"CDatabaseDriver::find_row: empty query")
        
                mongoDocuments = table.find()

            else:

                print(f"CDatabaseDriver::find_row query is {query} and projection is {projection}")

                if len(projection) == 0:
                    mongoDocuments = table.find(query)
                else:
                    mongoDocuments = table.find(query, projection)

            documents = []
            for document in mongoDocuments:

                documents.append(document)
                print(f"CDatabaseDriver::find_row: {document}")
            
            print(f"CDatabaseDriver::find_row: documents is {documents}")
            return documents
        
        except Exception as e:
            print(f"CDatabaseDriver::find_row: Error connecting to MongoDB: {e}")
            return None
    ...
    def get_database(self, database_name):
        ...
        try:
            ...
            if self.client is not None:
                ...
                print(f"CDatabaseDriver::get_database: database_name_list = {dblist}")
                print(f"CDatabaseDriver::get_database: database_name = {database_name}")
                ...
                print(f"CDatabaseDriver::get_database: null client")
                return None

        except errors.PyMongoError as e:
            print(f"CDatabaseDriver::get_database: Error connecting to MongoDB: {e}")
            return None
    ...
    def create_database(self, database_name):
        ...
        try:
            if self.client is not None:
                dblist = self.client.list_database_names()
                print(f"CDatabaseDriver::create_database: database_name_list = {dblist}")
                print(f"CDatabaseDriver::create_database: database_name = {database_name}")
                ...
                print(f"CDatabaseDriver::create_database: null client")
                return None

        except errors.PyMongoError as e:
            print(f"CDatabaseDriver::create_database: Error connecting to MongoDB: {e}")
            return None
    ...
    def delete_database(self, database_name):
        ...
        try:
            ...
            print(f"CDatabaseDriver::delete_database: Error connecting to MongoDB: {e}")
            return None
    ...
    def get_table(self, db, table_name):
        ...
        try:
            ...
            print(f"CDatabaseDriver::get_table: Error connecting to MongoDB: {e}")
            return None
    ...
    def create_table(self, db, table_name):
        ...
        try:
            ...
            print(f"CDatabaseDriver::create_table: Error connecting to MongoDB: {e}")
            return None
    ...
    def read_table(self, db, table_name):
        ...
        try:
            ...
            if db is not None:
                ...
                print(f"CDatabaseDriver::read_table: Error connecting to MongoDB: {e}")
                return []
    ...
    def update_table(self, db, table_name, rows, key_name):
        ...
        try:
            ...
            print(f"CDatabaseDriver::update_table: Error connecting to MongoDB: {e}")
            return []
    ...
    def delete_table(self, db, table_name):
        ...
        try:
            ...
            print(f"CDatabaseDriver::delete_table: Error connecting to MongoDB: {e}")
            return None
